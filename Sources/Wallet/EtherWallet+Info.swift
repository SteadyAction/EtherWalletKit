...
public protocol InfoService {
    func decimalsForTokenSync(address: String) throws -> String
    func decimalsForToken(address: String, completion: @escaping (String?) -> ())
...
extension EtherWallet: InfoService {
    public func decimalsForTokenSync(address: String) throws -> String {
    ...
    public func decimalsForToken(address: String, completion: @escaping (String?) -> ()) {
